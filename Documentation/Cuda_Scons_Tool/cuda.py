...
def generate(env):
    ...
    cuda_version_id = list(filter(str.isdigit, cuda_version_str))
    cuda_version_id = ''.join(cuda_version_id)
    cuda_version_id = cuda_version_id[:2]
    print('CUDA Version: '+cuda_version_id)
