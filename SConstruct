...
if os_architecture == '32bit':
    ...
    arc = 'amd64'
env = Environment(ENV = ENV, CPPPATH = include_path, MSVS_ARCH = arc, TARGET_ARCH = arc, MSVC_VERSION = msvc_version, MSVS_USE_RESPONSE_FILE=True)
